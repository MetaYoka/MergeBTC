window.__require = function e(t, n, o) {
        ...
        var a = e("./GameManager"),
            ...
            p = function (e) {
                ...
                return o(t, e), n = t, t.prototype.onLoad = function () {
                    ...
                    1 != e && (this.bencichengji.getComponent(cc.Sprite).spriteFrame = this.bencichengjiarr[e - 1], this.gengduoyouxi.getComponent(cc.Sprite).spriteFrame = this.gengduoyouxiarr[e - 1]), this.continueTip.getComponent(cc.Label).string = 1 == e ? "abcdabcdabcdabcd" : 2 == e ? "abcdabcdabcdabcd" : 4 == e ? "abcdabcd abcdabcd abcdabcd" : "Click Continue", this.reStartBtn.runAction(cc.repeatForever(cc.sequence(cc.scaleTo(.5, 1.1), cc.scaleTo(.55, 1), cc.delayTime(.5)))), cc.tween(this.moreGameBtn).to(.5, {
                        scale: 1.1
                    }).to(.5, {
                        scale: 1
                    ...
                    // window.location.href = "https://metayoka.io"
                    ...
                    this.scheduleOnce(function () {
                        r.default.Instance.HideScorePanel(), n.levelTxt.string = r.default.Instance.level.toString(), n.scoreLabel.string = s.default.score.toString(), n.highScoreLabel.string = t, n.resultTxt.string = n.GetContentByScore(e), n.overTxt.string = "abcdabcdabcdabcdabcdabcdabcd" + Math.floor(r.default.Instance.nowYQ / r.default.Instance.passlevelYQ * 100) + "%", n.canClick = !1, n.levelTxt.string = e, n.bgMask.runAction(cc.fadeTo(.36, 150)), n.scheduleOnce(function () {
                    ...
                    this.canClick && (this.moreGameBtn.off(cc.Node.EventType.TOUCH_START, this.OnClickMoreGame, this), this.canClick = !1, this.moreGameBtn.runAction(cc.sequence(cc.scaleTo(.1, 1.1), cc.scaleTo(.1, 1))), this.scheduleOnce(function () {
                        // window.location.href = "http://metayoka.io"
                    }, .15))
                }, t.prototype.GetContentByScore = function (e) {
                    var t = Math.ceil(e / 1500 * 94);
                    t > 94 && (t = 94);
                    var n = 5 + t;
                    return "abcdabcdabcdabcdabcd" + n + "%abcdabcdabcdabcd", ["abcdabcdabcdabcdabcd" + n + "%abcdabcdabcdabcd", "abcdabcdabcdabcdabcd" + n + "%abcdabcdabcdabcd", "Beat " + n + " % of global players", "abcd abcdabcd" + n + "% abcd abcd abcd abcd abcd abcd abcd abcd abcd"][i.default.returnCurrentLanType() - 1]
        ...
        var a = e("./FailedUi"),
            ...
            d = (l.property, function (e) {
                ...
                return o(t, e), n = t, t.prototype.onLoad = function () {
                    ...
                    if (this.score > t) {
                        t = this.score, r.default.Instance.SetPlayerHighScore(t)
                    }
                    ...
                    console.log("ToEnd.....")
                    cc.find("Canvas").getComponent("MainGameJS").gameEnd1(this.score)
    ...
    GameUiTools: [function (e, t, n) {
        ...
        var o = {
            newSprite: function (e, t) {
                var n = new cc.Node;
                return t ? (e = e.split(".")[0], n.addComponent(cc.Sprite).spriteFrame = GameTools.love2048FrameCache.getSpriteFrame(e)) : n.addComponent(cc.Sprite).spriteFrame = new cc.SpriteFrame("https://cdn.jsdelivr.net/gh/MetaYoka/MergeBTC/res/raw-assets/resources/" + e), n
            },
    ...
    HttpManagerJs: [function (e, t, n) {
        ...
        var a = e("GameConfig"),
            i = (c(o = {
                ...
                cc.log("abcdabcdabcdabcd"), this.isBusy = !1, this.perform.target ? this.perform.func.call(this.perform.target, -1) : this.perform.func(-1)
            ...
            p = function (e) {
                ...
                return o(t, e), n = t, t.prototype.onLoad = function () {
                    ...
                    i.default.playerTouch && null != a.default.Instance.targetFruit && 1 == this.touchNum && (this.touchNum = 0, a.default.Instance.targetFruit.getComponent(cc.PhysicsCircleCollider).radius = a.default.Instance.targetFruit.height / 2, a.default.Instance.targetFruit.getComponent(cc.PhysicsCircleCollider).apply(), a.default.Instance.targetFruit.getComponent(cc.RigidBody).type = cc.RigidBodyType.Dynamic, a.default.Instance.targetFruit.getComponent(cc.RigidBody).linearVelocity = cc.v2(0, -800), a.default.Instance.targetFruit = null, this.scheduleOnce(function () {
                        ...
                        //     cc.log("...........", t.createFruitCount);

                        //     if (0 == t.createFruitCount) {
                        //         (a.default.Instance.createOneFruit(0), t.createFruitCount++)
                        //     } else {
                        //         if (1 == t.createFruitCount) {
                        //             (a.default.Instance.createOneFruit(9), t.createFruitCount++)
                        //         } else if (2 == t.createFruitCount) {
                        //             (a.default.Instance.createOneFruit(8), t.createFruitCount++)
                        //         } else if (
                        //             3 == t.createFruitCount) {
                        //             (a.default.Instance.createOneFruit(7), t.createFruitCount++)

                        //         } else if (4 == t.createFruitCount) {
                        //             (a.default.Instance.createOneFruit(6), t.createFruitCount++)

                        //         } else if (5 == t.createFruitCount) {
                        //             (a.default.Instance.createOneFruit(5), t.createFruitCount++)
                        //         } else if (6 == t.createFruitCount) {
                        //             (a.default.Instance.createOneFruit(4), t.createFruitCount++)
                        //         } else if (7 == t.createFruitCount) {
                        //             (a.default.Instance.createOneFruit(3), t.createFruitCount++)
                        //         } else if (8 == t.createFruitCount) {
                        //             (a.default.Instance.createOneFruit(2), t.createFruitCount++)
                        //         } else if (9 == t.createFruitCount) {
                        //             (a.default.Instance.createOneFruit(1), t.createFruitCount++)
                        //         } else if (t.createFruitCount > 9) {
                        //             (a.default.Instance.createOneFruit(s.default.RandomInteger(window.difficulty[0], window.difficulty[1])), t.createFruitCount++)
                        //         }
                        //     }
                        // }
    ...
    LanguageSetJs: [function (e, t, n) {
        ...
        t.exports = {
            language_1: {
                game_name: "abcdabcdabcdabcdabcd",
                game_name1: "abcdabcdabcd",
                game_info: "abcdabcdabcdabcdabcdabcdabcdabcdabcdabcd",
                txtStart: "abcdabcd",
                txtMore: "abcdabcdabcdabcd",
                txtAgain: "abcdabcdabcdabcd",
                txtShare1: "abcdabcdabcdabcd ",
                txtShare2: "abcdabcdabcdabcdabcdabcd!abcdabcdabcdabcdabcdabcdabcdabcd!",
                bgRgb: "#3698C5",
                gameT1: "abcdabcdabcdabcd",
                gameT2: "abcdabcdabcdabcd",
                gameT3: "abcdabcdabcdabcd",
                gameUrl1: "http://merge.metayoka.io",
                gameUrl2: "http://merge.metayoka.io",
                gameT11: "abcdabcdabcdabcd",
                gameT12: "abcdabcdKakao",
                gameT13: "abcdabcdLine",
                gameEndL: "abcd abcd abcd abcd",
                gameEndL1: "abcd abcd abcd abcd abcd abcd"
            },
            language_2: {
                game_name: "abcdShot Applesabcd",
    ...
    MainGameJS: [function (e, t, n) {
        ...
        cc.Class({
            ...
            gameEnd1: function (score) {
                ...
                setUserScore(score)
                zE && zE('messenger:set', 'zIndex', 1000);
            ...
            gameOverGoToOVer: function () {
                if (this.gameOveEndBool) {
                    this.gameOverNum++;

                    if (this.gameOverNum >= 900) {
                        this.gameOverNum = 0;
            ...
            SetGameEndScore: function () {
                console.log("SetGameEndScore", o.gameScore)
                ge("curScoreNum").innerHTML = this.gameScore;

                a.gameOverShowText(o.gameScore, 1)
            },
            GetGameEndInfo: function () {
                console.log("GetGameEndInfo")
        ...
        var o = e("HttpManagerJs"),
            ...
            r = (e("GameUiTools"), {
                ...
                initLanguage: function () {
                    var e = null;
                    return cc.sys.language == cc.sys.LANGUAGE_CHINESE ? (this.curType = 1, e = c.language_1) : (cc.log("abcdabcd"), this.curType = 2, e = c.language_2), e
                },
    ...
    NewAttribute: [function (e, t, n) {
        ...
        var c = cc._decorator,
            ...
            r = function () {
                function e() {
                    this.nickName = "abcdabcdabcd", this.qGroup = "704391772"
                }
                return o([i({
                    displayName: "abcdabcd"
        ...
        var a = cc._decorator,
            ...
            s = function (e) {
                ...
                return o(t, e), n = t, t.prototype.onLoad = function () {
                    ...
                    if (!n.Instance.poolMap.has(e)) return cc.log("abcdabcdabcdabcd,abcdabcdabcd : " + e), null;
        ...
        var i = cc._decorator,
            ...
            l = function (e) {
                ...
                return c(t, e), t.prototype.start = function () {
                    ...
                    tooltip: "abcdabcdabcdabcdabcdabcd"
    ...
    ToolsJs: [function (e, t, n) {
        ...
        var o = {
            ...
            clonePrefabs: function (e, t, n) {
                ...
                return console.log("abcdabcdabcdabcdabcdabcdabcd:" + e), null
            },
            ...
            newAduioSource: function (e) {
                ...
                if (null != this.AudioArrJs) t = this.AudioArrJs.getAudioClip(e);
                    ...
                    if (null == e) return console.log("clipabcdabcdabcdabcdabcd"), null;
                    t = e
                }
                var n = new cc.Node;
    ...
    Utils: [function (e, t, n) {
        ...
        var o = function () {
            ...
            return e.getBezierPos = function (e, t) {
                var n = new Array,
                    o = e.length;
                if (o < 2) return cc.log("abcdabcdabcdabcdabcdabcdabcdabcd 2"), n;
    ...
    gameOverJs: [function (e, t, n) {
        ...
        cc.Class({
            ...
            onLoad: function () {
                ...
                var e = "abcdabcdabcdabcd:",
                    t = this.returnCurrentLanType();
                e = 1 == t ? "abcdabcdabcdabcd:" : 2 == t ? "abcdabcdabcdabcd:" : 4 == t ? "abcdabcd abcdabcd:" : "Highest Record:";
                var n = c.gameScore,
                    o = this.getHighScore();
            ...
            UIPosChange: function () {
                ...
                var e = null;
                e = 1 == a.langugeType ? this.getContentByScore(c.gameScore, a.gameNameText) : this.getContentByScore2(c.gameScore, a.gameNameText), null != a.endHttpShowInfo && "" != a.endHttpShowInfo && (cc.log("gototo"), e = a.endHttpShowInfo), this.overInfoT.string = e;
            ...
            getContentByScore: function (e, t) {
                var n = "abcdabcdabcdabcdabcdabcdabcdabcd" + t + "abcdabcdabcdabcdabcd1abcdabcdabcdabcdabcdabcd1abcdabcdabcd1abcdabcd",
                ...
                if (e > 0 && e <= o) n = "abcdabcd" + t + "abcdabcdabcd" + e + "abcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcd";
                else if (e > o && e <= this.standardScore) n = "abcdabcd" + t + "abcdabcdabcd" + e + "abcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcd";
                else if (e > this.standardScore && e <= c) {
                    n = "abcdabcd" + t + "abcdabcdabcd" + e + "abcdabcdabcdabcdabcdabcdabcd" + (Math.floor(12 * (e - this.standardScore) / (c - this.standardScore)) + 80) + "%abcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcd"
                } else if (e > c && e <= a) {
                    n = "abcdabcd" + t + "abcdabcdabcd" + e + "abcdabcdabcdabcdabcdabcdabcd" + (Math.floor(7 * (e - c) / (a - c)) + 92) + "%abcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcd"
                } else if (e > a && e <= i) n = "abcdabcd" + t + "abcdabcdabcd" + e + "abcdabcdabcdabcdabcdabcdabcd99%abcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcd";
                else if (e > i && e < this.game_max_score) {
                    n = "abcdabcd" + t + "abcdabcdabcd" + e + "abcdabcdabcdabcdabcdabcdabcdabcd " + (20 - Math.ceil(17 * (e - i) / (this.game_max_score - i))) + "abcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcd"
                } else e >= this.game_max_score && (n = "abcdabcd" + t + "abcdabcdabcd" + e + "abcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcd");
                return n
            },
            strlen: function (e) {
            ...
            getContentByScore2: function (e, t) {
                console.log("getContentByScore2")
                var n = "I'm awesomeabcdin" + t + "get 0 scoreabcdonly one person in the world has a 0abcd",
                    o = parseInt(.3 * this.standardScore),
                    c = parseInt(1.5 * this.standardScore),
                    a = parseInt(2.5 * this.standardScore),
                    i = parseInt(4 * this.standardScore);
                if (e >= this.game_max_score) n = "I got " + e + " points in the game, defeating all players worldwide, waiting for you to fight!";
                else if (e > 0 && e <= o) n = "I got " + e + " points in the game, really greatabcd";
                else if (e > o && e <= this.standardScore) n = "I got " + e + " points in the game, really greatabcd";
                else if (e > this.standardScore && e <= c) {
                    n = "I got in the game in " + e + " points, beating out " + (Math.floor(12 * (e - this.standardScore) / (c - this.standardScore)) + 80) + "% of global playersabcd"
                } else if (e > c && e <= a) {
                    n = "I got in the game in " + e + " points, beating out " + (Math.floor(7 * (e - c) / (a - c)) + 92) + "% of global playersabcd"
                } else if (e > a && e <= i) n = "I got in the game in " + e + " points, beating out 99% of global playersabcd";
                else if (e > i && e < this.game_max_score) {
        ...
        cc._RF.push(t, "8a68e/WQz1Feo++msjg6z8R", "resArr"), cc.Class({
            ...
            playAudio: function (e) {
                var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : .3,
                    n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2];
                return null != this.audioClipDic[e] ? cc.audioEngine.play(this.audioClipDic[e], n, t) : (console.log("abcdabcdabcdabcdabcdabcdabcd" + e), null)
            },
            getAudioClip: function (e) {
                return null != this.audioClipDic[e] ? this.audioClipDic[e] : (console.log("abcdabcdabcdabcdabcdabcdabcd" + e), null)
            },
            ...
            getSpriteFrame: function (e) {
                return null != this.spriteArr[e] ? this.spriteArr[e] : (console.log("abcdabcdabcdabcdabcdabcdabcd" + e), null)
            },
            addPrefabs: function () {
                this.prefabsArr = {};
            ...
            getPrefabs: function (e) {
                return null != this.prefabsArr[e] ? this.prefabsArr[e] : (console.log("abcdabcdabcdabcdabcdabcd" + e), null)
            }
        }), cc._RF.pop()
    }, {}],
