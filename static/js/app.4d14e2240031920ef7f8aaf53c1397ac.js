...
function buyYoka() {
    window.location.href = "https://metayoka.io/yoka?ref=merge"
}
...
function showChestPage() {
    ge('chestPage').className = 'show';
...
function start() {
    ...
    //     console.log('hhh')
    // }
    var spans = document.querySelectorAll("div.chest-items>span");
    ...
    timer = setInterval(function () {
        ...
        if (time > times) {
            ...
            clearInterval(timer);
            console.log('恭喜您抽中了' + spans[num].textContent + '!!!')
