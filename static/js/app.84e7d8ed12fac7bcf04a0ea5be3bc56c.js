...
};let _hostUrl = 'https://testapicorsair.metayoka.io';
let http = {
...
let api = {
    BASE_URI: "https://testapicorsair.metayoka.io",
...
window.boot = function () {
    ...
    var bundledScript = settings.debug ? 'js/project.dev.js' : 'https://cdn.jsdelivr.net/gh/MetaYoka/MergeBTC/static/js/project.7a821b53b7e84e297854d5650a241ad8.js';
    if (jsList) {
...
function getRankList() {
    ...
    Service.getUsersList((respondData) => {
        ...
        rankData.map((user, index) => {
            ...
            if (user.rank < 4) {
                _rankItemHtml +=
                    '<img src="./images/rank_' + user.rank + '.png">';
            }
            _rankItemHtml += '</div>' +
            ...
            _rankItemHtml += '</div>' +
                ...
                ' <img src="./images/coin.svg?v=0.10" alt="">' +
                '</div>' +
                ' </div>';
        ...
        if (mineRank) {
            ...
            mineRankHtml += '</div><div class="type point"> ' +
                ...
                mineRank.spice +
                '<img src="./images/coin.svg?v=0.10" alt=""></div>';
